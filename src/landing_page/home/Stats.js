                ...
                <div className="row p-5">
                    ...
                    <div className="col-7 p-5">
                        ...
                        <div className='text-center'>
                            <a href="" className='mx-3' style={{textDecoration:"none"}} >Explore our products <i style={{color:"blue"}} class="fa-solid fa-arrow-right"></i></a>
                            <a href="" style={{textDecoration:"none"}} >Try Kite demo <i style={{color:"blue"}} class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
