        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div className="col-5" style={{marginTop:"100px"}}>
                    ...
                    <a className='mb-4' href="" style={{textDecoration:"none"}} >Varsity <i style={{color:"blue"}} class="fa-solid fa-arrow-right"></i></a>
                    ...
                    <a className='mb-4' href="" style={{textDecoration:"none"}} >TradingQ&A <i style={{color:"blue"}} class="fa-solid fa-arrow-right"></i></a>
                </div>
